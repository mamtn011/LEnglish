...
const Where = () => {
  return (
    <div className="w-full">
      <button className="btn-lesson p-1">Where</button>
      <div className={`flex flex-col gap-4 mb-6`}>
        <div>
          <p className="font-bold py-2">Description:</p>
          <div className="py-2">
            <p>Where = কোথায় / কী অবস্থায়</p>
          </div>
          <p>Where-family + auxiliary verb + subject + verb + object</p>
        </div>
        <p className="font-bold">Examples:</p>
        <div>
          <p>তারা কোথায় যাচ্ছে?</p>
          <p>Where are they going?</p>
        </div>
        <div>
          <p>আমার কোথায় ইংরেজি শেখা উচিৎ?</p>
          <p>Where should I learn English?</p>
        </div>
        <div>
          <p>তোমাদের কলেজ কোথায় অবস্থিত?</p>
          <p>Where is your college situated?</p>
        </div>
        <div>
          <p>তুমি কোথায় ছিলে?</p>
          <p>Where were you?</p>
        ...
        <div>
          <p>তুমি এতদিন কোথায় ছিলে?</p>
          <p>Where had you been so long?</p>
        </div>
        <div>
          <p>তুমি কোথায় এই হারামিদের সাথে দেখা করেছিলে?</p>
          <p>Where did you meet with these devils?</p>
        </div>
        <div>
          <p>
        ...
        <div>
          <p className="text-blue-500">
            Whereabouts = কোনখানে / কোন জায়গার কাছে / খোঁজখবর
          </p>
          <p>কোনখানে তুমি আমার বন্ধুকে খুঁজে পেয়েছ?</p>
          <p>Whereabouts have you found out my friend?</p>
        </div>
        <div>
          <p>তুমি কি তার কোন খোঁজখবর জান?</p>
          <p>Do you know her whereabouts?</p>
        </div>
        <div>
          <p className="text-blue-500">Wherein = কিসে / কোন বিষয়ে</p>
          <p>কিসে অনেক সমস্যা আছে?</p>
          <p>Wherein are there many problems?</p>
        </div>
        <div>
          <p>আমার ভুল কিসে?</p>
          <p>Wherein am I wrong?</p>
        </div>
        <div>
          <p>তুমি কিসে সফলতা পেতে চেষ্টা করছ?</p>
          <p>Wherein are you trying to gain success?</p>
        </div>
        <div>
          <p className="text-blue-500">The whys and wherefores = কারণসমূহ</p>
          <p>তুমি কি তার ব্যর্থতার কারণসমূহ জান?</p>
          <p>Do you know the whys and wherefores of his failure?</p>
        </div>
        <div>
          <p>
            তোমার কি বাংলাদেশের খেলোয়ারদের ব্যর্থতার কারণসমূহ সম্পর্কে কোন ধারনা
            আছে?
          </p>
          <p>
            Do you have any idea about the whys and wherefores of the failure of
        ...
        <div>
          <p className="text-blue-500">
            Wherewith/Whereby = যার দ্বারা/মাধ্যমে
          </p>
          <p>
